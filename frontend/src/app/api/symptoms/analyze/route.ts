      ...
      return NextResponse.json<SymptomAnalysisResponse>(
        {
          urgency: 'critical',
          isEmergency: true,
          recommendation: '🚨 EMERGENCY: Call 911 immediately or go to the nearest emergency room. The symptoms described may indicate a life-threatening condition that requires immediate medical attention.',
          warningSignsToWatch: [
